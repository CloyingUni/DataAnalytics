...
if paired_results:
    ...
    #axhline is used in these to make a horizontal line across the graph, here it shows y = 0.05, the significance level
    ...
    # here axhline is used to show y = 0, which allows the simpsons evenness to be seen as positive or negative, negative in this case
